	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a class="fa fa-facebook" href="https://www.facebook.com/LePlateauCoffee22"></a>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="chamsockhachhang.html"><i class="fa fa-wrench"></i> Chăm Sóc Khách Hàng</a></li>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Thanh Tùng Cafe Shop </a> - All rights reserved T 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Thanh Tùng - Đông Chinh</span></p>
    </div>`);
}
